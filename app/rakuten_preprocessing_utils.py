...
def translate_text(text):
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="erreur dans la détection de la langue du texte")
    ...
    if lang_found == "fr":
        ...
        try:
            ...
            french_text = text
            #print("PB with Google translate , text kept in its foreign language")
...
def suppress_white_areas(path, name_img):
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="erreur dans le traitement de l image fournie, objet non détecté")
